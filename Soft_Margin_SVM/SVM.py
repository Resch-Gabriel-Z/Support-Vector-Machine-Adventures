...
class SVM:
    ...
    def __init__(self, learning_rate=0.0001, lambda_param=0.001, iterations=10000, batch_size=64, optim='GD'):
        """

        Args:
            learning_rate: the learning rate
            lambda_param: the lambda parameter for regularization
    ...
    def fit(self, X, y):
        ...
        if self.optim == 'GD':
            self.weights, self.bias = gradient_descent(weights=self.weights, bias=self.bias, lr=self.lr, X=X, y=y_,
